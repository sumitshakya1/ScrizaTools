...
export const metadata: Metadata = {
  title: "Sign In or Sign Up — ToolOn | Free Online Image & PDF Tools",
  description:
    "Sign in to your ToolOn account or create a new free account to access high-speed browser-native image converters, PDF tools, and compression utilities.",
  alternates: {
    canonical: "https://www.toolon.in/signin",
  },
};
