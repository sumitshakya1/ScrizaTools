import { whyScrizaItems } from "@/data/tools";
import { DynamicIcon } from "@/components/icons";
import { Sparkles } from "lucide-react";

export function WhyScriza() {
  return (
    <section id="why-scriza" className="scroll-mt-20 py-14 md:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-primary-fixed/50 px-3.5 py-1 text-xs font-bold text-primary mb-3">
            ...
            <span>The Scriza Advantage</span>
          </div>
