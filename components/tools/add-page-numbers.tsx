...
import {
  UploadCloud, FileText, Trash2, Loader2, Hash
} from "lucide-react";
...
import { addPdfPageNumbers } from "@/lib/pdf-engine";

const FAQS: FAQItem[] = [
  { question: "Where are the page numbers added?", answer: "Page numbers are added to the bottom center of each page in '1 / N' format." },
...
export function AddPageNumbersTool() {
  ...
  const handleProcess = async () => {
    ...
    try {
      const processed = await addPdfPageNumbers(file);
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <ToolSectionCard title="Select Document" subtitle="Upload the PDF you want to add numbers to">
            {!file ? (
              <div
        ...
        <div className="lg:col-span-1">
          <FAQSection toolName="Add Page Numbers" items={FAQS} />
        </div>
      </div>
